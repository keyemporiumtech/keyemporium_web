...
export class FigureBuilder {
  static run() {
    ...
    go.Shape.defineFigureGenerator('LineLeft', function (shape, w, h) {
      return new go.Geometry().add(
        new go.PathFigure(0.75 * w, 0, false)
    ...
    go.Shape.defineFigureGenerator('LineUp', function (shape, w, h) {
      return new go.Geometry().add(
        new go.PathFigure(0, 0.75 * h, false)
    ...
    go.Shape.defineFigureGenerator('FramedRectangle', (shape, w, h) => {
      ...
      if (param1 < w / 2 && param2 < h / 2) {
        ...
        fig.add(
          new go.PathSegment(go.PathSegment.Line, w - param1, h - param2)
        );
        fig.add(
    ...
    go.Shape.defineFigureGenerator('Lightning', (shape, w, h) => {
      return new go.Geometry().add(
        new go.PathFigure(0, 0.55 * h)
          ...
          .add(
            new go.PathSegment(go.PathSegment.Line, 0.7 * w, 0.55 * h).close()
          )
      );
    });
    ...
    go.Shape.defineFigureGenerator('GenderFemale', (shape, w, h) => {
      ...
      fig.add(
        new go.PathSegment(go.PathSegment.Line, 0.525 * w, 0.85 * h).close()
      );
      // Inner circle
      r = 0.325; // radius
      cx = 0; // offset from Center x
    ...
    go.Shape.defineFigureGenerator('Chevron', (shape, w, h) => {
      ...
      fig.add(new go.PathSegment(go.PathSegment.Line, 0, h));
      fig.add(
        new go.PathSegment(go.PathSegment.Line, 0.5 * w, 0.5 * h).close()
      );
      return geo;
    });
  ...
  */
      ...
      fig.add(new go.PathSegment(go.PathSegment.Line, 0.7 * w, y1));
      fig.add(
        new go.PathSegment(go.PathSegment.Line, 0.7 * w, y1outer).close()
      );
      let temp = getIntersection(
        0,
        0.5,
    ...
    go.Shape.defineFigureGenerator('DataStorage', (shape, w, h) => {
      ...
      fig.add(new go.PathSegment(go.PathSegment.Line, 0.75 * w, 0));
      fig.add(
        new go.PathSegment(go.PathSegment.Bezier, 0.75 * w, h, w, 0, w, h)
      );
      fig.add(new go.PathSegment(go.PathSegment.Line, 0, h));
      fig.add(
        new go.PathSegment(
    ...
    go.Shape.defineFigureGenerator('MicroformProcessing', (shape, w, h) => {
      ...
      fig.add(new go.PathSegment(go.PathSegment.Line, w, h));
      fig.add(
        new go.PathSegment(go.PathSegment.Line, 0.5 * w, (1 - param1) * h)
      );
      fig.add(new go.PathSegment(go.PathSegment.Line, 0, h).close());
      // ??? geo.spot1 = new go.Spot(0, param1);
      // ??? geo.spot2 = new go.Spot(1, 1 - param1);
    ...
    go.Shape.defineFigureGenerator('PrimitiveFromCall', (shape, w, h) => {
      ...
      fig.add(new go.PathSegment(go.PathSegment.Line, w, 0));
      fig.add(
        new go.PathSegment(go.PathSegment.Line, (1 - param2) * w, 0.5 * h)
      );
      fig.add(new go.PathSegment(go.PathSegment.Line, w, h));
      fig.add(new go.PathSegment(go.PathSegment.Line, 0, h).close());
    ...
    go.Shape.defineFigureGenerator('TransmittalTape', (shape, w, h) => {
      ...
      fig.add(new go.PathSegment(go.PathSegment.Line, w, h));
      fig.add(
        new go.PathSegment(go.PathSegment.Line, 0.75 * w, (1 - param1) * h)
      );
      fig.add(
        new go.PathSegment(go.PathSegment.Line, 0, (1 - param1) * h).close()
      );
      geo.spot1 = go.Spot.TopLeft;
      // ??? geo.spot2 = new go.Spot(1, 1 - param1);
      return geo;
    ...
    go.Shape.defineFigureGenerator('BpmnActivityLoop', (shape, w, h) => {
      ...
      // Arrowhead
      fig.add(
        new go.PathSegment(go.PathSegment.Move, (0.25 + cx) * w, 0.8 * h)
      );
      fig.add(
        new go.PathSegment(go.PathSegment.Line, (0.35 + cx) * w, 0.9 * h)
      );
      fig.add(
        new go.PathSegment(go.PathSegment.Line, (0.2 + cx) * w, 0.95 * h)
      );
      return geo;
    });
    ...
    go.Shape.defineFigureGenerator('BpmnEventError', (shape, w, h) => {
      ...
      fig.add(
        new go.PathSegment(go.PathSegment.Line, 0.33 * w, 0.5 * h).close()
      );
      return geo;
    });
    ...
    go.Shape.defineFigureGenerator('Caution', (shape, w, h) => {
      ...
      fig.add(
        new go.PathSegment(go.PathSegment.Bezier, 0.9 * w, h, w, h, w, h)
      );
    ...
    go.Shape.defineFigureGenerator('Package', (shape, w, h) => {
      ...
      fig2.add(
        new go.PathSegment(go.PathSegment.Line, 0.65 * w, 0.15 * h).close()
      );
    ...
    go.Shape.defineFigureGenerator('RailShipment', (shape, w, h) => {
      ...
      fig.add(
        new go.PathSegment(go.PathSegment.Line, 0.1 * w, 0.4 * h).close()
      );
      ...
      fig3.add(
        new go.PathSegment(go.PathSegment.Line, 0.55 * w, 0.4 * h).close()
      );
      let radius = 0.05;
    ...
    go.Shape.defineFigureGenerator('ControlCenter', (shape, w, h) => {
      ...
      fig.add(
        new go.PathSegment(go.PathSegment.Line, 0.9 * w, 0.8 * h).close()
      );
      return geo;
    });
    ...
    go.Shape.defineFigureGenerator('Operator', (shape, w, h) => {
      ...
      geo.add(fig2);
      fig2.add(
        new go.PathSegment(go.PathSegment.Bezier, w, 0.7 * h, 0, 0, w, 0)
      );
      return geo;
    });
    ...
    go.Shape.defineFigureGenerator('Gear', (shape, w, h) => {
      return new go.Geometry().add(
        new go.PathFigure(0.9375 * w, 0.56246875 * h, true)
          ...
          .add(
            new go.PathSegment(go.PathSegment.Line, 0.80621875 * w, 0.4375 * h)
          )
          .add(
            new go.PathSegment(
              go.PathSegment.Bezier,
          ...
          .add(
            new go.PathSegment(go.PathSegment.Line, 0.76825 * w, 0.14959375 * h)
          )
          .add(
            new go.PathSegment(
              go.PathSegment.Line,
          ...
          .add(
            new go.PathSegment(go.PathSegment.Line, 0.4375 * w, 0.19378125 * h)
          )
          .add(
            new go.PathSegment(
              go.PathSegment.Bezier,
          ...
          .add(
            new go.PathSegment(go.PathSegment.Line, 0.1938125 * w, 0.5625 * h)
          )
          .add(
            new go.PathSegment(
              go.PathSegment.Bezier,
          ...
          .add(
            new go.PathSegment(go.PathSegment.Line, 0.1495625 * w, 0.76825 * h)
          )
          .add(
            new go.PathSegment(go.PathSegment.Line, 0.238 * w, 0.8566875 * h)
          )
          .add(
            new go.PathSegment(
              go.PathSegment.Line,
          ...
          .add(
            new go.PathSegment(go.PathSegment.Line, 0.43753125 * w, 0.9375 * h)
          )
          .add(new go.PathSegment(go.PathSegment.Line, 0.5625 * w, 0.9375 * h))
          .add(
            new go.PathSegment(go.PathSegment.Line, 0.5625 * w, 0.80621875 * h)
          )
          .add(
            new go.PathSegment(
              go.PathSegment.Bezier,
          ...
          .add(
            new go.PathSegment(go.PathSegment.Line, 0.85671875 * w, 0.76825 * h)
          )
          .add(
            new go.PathSegment(
              go.PathSegment.Line,
    ...
    go.Shape.defineFigureGenerator('Building', (shape, w, h) => {
      ...
      fig.add(
        new go.PathSegment(go.PathSegment.Line, (1 - 0.046) * w, h * 0.3)
      );
      fig.add(new go.PathSegment(go.PathSegment.Line, w, h * 0.3));
      fig.add(new go.PathSegment(go.PathSegment.Line, w, h * 0.45));
      fig.add(
        new go.PathSegment(go.PathSegment.Line, (1 - 0.046) * w, h * 0.45)
      );
      fig.add(
        new go.PathSegment(go.PathSegment.Line, (1 - 0.046) * w, h * 0.85)
      );
    ...
    go.Shape.defineFigureGenerator('5Bars', (shape, w, h) => {
      ...
      geo.add(fig3);
      fig3.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.204, h * (1 - 0.184))
      );
      fig3.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.388, h * (1 - 0.184 * 2))
      );
      fig3.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.388, h * 1).close()
      );
      ...
      fig4.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.592, h * 1).close()
      );
      ...
      fig5.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.796, h * 1).close()
      );
      ...
      fig6.add(
        new go.PathSegment(go.PathSegment.Line, w * 1, h * (1 - 0.184 * 5))
      );
    ...
    go.Shape.defineFigureGenerator('PC', (shape, w, h) => {
      ...
      fig2.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.055, h * 0.1).close()
      );
      ...
      fig5.add(
        new go.PathSegment(go.PathSegment.Line, w * 1, h * 0.65).close()
      );
      return geo;
    });
    ...
    go.Shape.defineFigureGenerator('Key', (shape, w, h) => {
      ...
      fig.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.9, 0.6 * h).close()
      );
    ...
    go.Shape.defineFigureGenerator('FilmTape', (shape, w, h) => {
      ...
      fig3.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.11, h * 0.8).close()
      );
      const fig4 = new go.PathFigure(
    ...
    go.Shape.defineFigureGenerator('FloppyDisk', (shape, w, h) => {
      ...
      fig2.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.17, h * 0).close()
      );
      ...
      fig3.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.17, h * 1).close()
      );
      ...
      fig4.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.78, h * 0.25).close()
      );
      return geo;
    });
    ...
    go.Shape.defineFigureGenerator('Repeat', (shape, w, h) => {
      ...
      fig.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.2, h * 0.45).close()
      );
      ...
      fig2.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.8, h * 0.55).close()
      );
      return geo;
    });
    ...
    go.Shape.defineFigureGenerator('Windows', (shape, w, h) => {
      return new go.Geometry().add(
        new go.PathFigure(0, 0, true)
          ...
          .add(
            new go.PathSegment(go.PathSegment.Line, 0.9 * w, 0.4 * h).close()
          )
          ...
          .add(
            new go.PathSegment(go.PathSegment.Line, 0.7 * w, 0.1 * h).close()
          )
          ...
          .add(
            new go.PathSegment(go.PathSegment.Line, 0.5 * w, 0.6 * h).close()
          )
      );
    });
    ...
    go.Shape.defineFigureGenerator('Terminal', (shape, w, h) => {
      ...
      fig3.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.28, h * 0.41).close()
      );
      return geo;
    });
    ...
    go.Shape.defineFigureGenerator('Beaker', (shape, w, h) => {
      ...
      fig.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.62, h * 0.03).close()
      );
      if (cpOffset > 1) {
        geo.spot1 = new go.Spot(0, 0, cpOffset, cpOffset);
        geo.spot2 = new go.Spot(1, 1, -cpOffset, -cpOffset);
    ...
    go.Shape.defineFigureGenerator('Download', (shape, w, h) => {
      ...
      fig.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.93, h * (1 - third))
      );
      fig.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.64, h * (1 - third))
      );
      ...
      fig.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.36, h * (1 - third))
      );
      fig.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.07, h * (1 - third))
      );
      fig.add(
        new go.PathSegment(go.PathSegment.Line, w * (1 - 0.755), h * 0.055)
      );
      fig.add(
        new go.PathSegment(go.PathSegment.Line, w * (1 - 0.66), h * 0.055)
      );
      ...
      fig2.add(
        new go.PathSegment(go.PathSegment.Line, w * (1 - 0.26), h * 0.44)
      );
    ...
    go.Shape.defineFigureGenerator('Upload', (shape, w, h) => {
      ...
      fig2.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.74, h * 0.25).close()
      );
    ...
    go.Shape.defineFigureGenerator('4Arrows', (shape, w, h) => {
      ...
      fig.add(
        new go.PathSegment(go.PathSegment.Line, w * 0.35, h * 0.25).close()
      );
      return geo;
    });
