...
@Component({
	selector: 'wiki-test-pagination-simple',
	templateUrl: './test-pagination-simple.component.html',
	styleUrls: ['./test-pagination-simple.component.scss'],
})
export class TestPaginationSimpleComponent extends BaseSearchComponent<ProvaPaginationModel> {
